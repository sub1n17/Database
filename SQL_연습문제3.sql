...
CREATE TABLE `Register` (
	regStdNo CHAR(8), -- 학생번호과 강좌번호로 식별
    regLecNo INT,
    regMidScore TINYINT,
...
INSERT INTO `Student` VALUES ('20220521', '송상현', '010-1234-1006', 1, '부신시 동래구');
...
INSERT INTO `Lecture` VALUES (349, '사회복지 마케딩', 2, 50, '본301');
...
SELECT
    ...
    regTotalScore,
    regGrade
FROM `Student` AS a, `Register` AS b WHERE a.stdNo = b.regStdNo; -- WHERE 절로 JOIN

# 실습 3-20
SELECT stdName, stdNo, regLecNo
FROM `Student` AS a
JOIN `Register` AS b
ON a.stdNo = b.regStdNo WHERE regLedNo=349;
